...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        SpecialThread q = new SpecialThread();
        SpecialThread qw = new SpecialThread();
        SpecialThread qr = new SpecialThread();
        SpecialThread qe = new SpecialThread();
        SpecialThread qt = new SpecialThread();

        list.add(new Thread(q));
        list.add(new Thread(qw));
        list.add(new Thread(qr));
        list.add(new Thread(qe));
        list.add(new Thread(qt));
